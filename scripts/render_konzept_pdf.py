#!/usr/bin/env python3
"""Render DocuPi-Konzept (Markdown) → PDF via WeasyPrint."""
import markdown
from weasyprint import HTML, CSS
from pathlib import Path

src = Path("/home/lord3000/Claude_workspace/claude-workspace-docupi/outputs/docupi-3000_konzept_getmatic.md")
...
<head>
<meta charset="utf-8">
<title>DocuPi-3000 — Konzept getmatic</title>
</head>
<body>
{html_body}
</body>
...
@page {
    ...
    @bottom-left {
        content: "DocuPi-3000 · Konzept für getmatic · April 2026";
        font-family: "Helvetica", "Arial", sans-serif;
        font-size: 9pt;
        color: #888;
    }
